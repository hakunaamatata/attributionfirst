  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 bg-bg-card border border-border text-primary rounded-full shadow-lg shadow-black/20 light:shadow-slate-900/10 hover:shadow-xl hover:shadow-accent/15 transition-all duration-200 hover:scale-105 hover:border-accent/30 cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        aria-label="Call now"
      >
        <Phone className="w-6 h-6" aria-hidden="true" />
        <span className="absolute right-full mr-3 px-3 py-1.5 bg-bg-card text-primary text-xs font-medium rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-lg border border-border">
          Call Now
        </span>
      </a>
      <a
