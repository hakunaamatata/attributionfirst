      ...
      <div className="container-wide relative px-5 md:px-8 lg:px-12">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <motion.div style={{ y: contentY }}>
            ...
            <motion.p
              className="mt-4 max-w-lg text-sm leading-[1.7] text-muted-dim md:text-base"
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex -space-x-2">
                {[
                  { letter: "M", title: "Michael · Strategy" },
                  { letter: "J", title: "Junaid · Paid Search" },
                  { letter: "N", title: "Noumaan · Technology" },
                ].map(({ letter, title }) => (
                  <div
                    key={letter}
                    title={title}
